        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('slambook.process') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="age" name="age" value="{{ old('age', $data['age'] ?? '') }}" min="1"
                        max="120" required>
                </div>
                @endif
                ...
                <div class="form-group">
                    ...
                    <select name="zodiac_sign" id="zodiac_sign" required>
                        ...
                        <option value="Libra" {{ old('zodiac_sign', $data['zodiac_sign'] ?? '' )=='Libra' ? 'selected'
                            : '' }}>
                            Libra</option>
                        <option value="Scorpio" {{ old('zodiac_sign', $data['zodiac_sign'] ?? '' )=='Scorpio'
                            ? 'selected' : '' }}>Scorpio</option>
                        ...
                        <option value="Aquarius" {{ old('zodiac_sign', $data['zodiac_sign'] ?? '' )=='Aquarius'
                            ? 'selected' : '' }}>Aquarius</option>
